...
urlpatterns = [
    ...
    path('user/profile/delete/', SeekerDeleteView.as_view(), name='seeker_delete_profile'),
    ...
    path('shelter/profile/delete/', ShelterDeleteView.as_view(), name='shelter_delete_profile')
]
