...
urlpatterns = [
    ...
    path('shelter/<int:shelter_id>/comment/', ShelterReviewCreateView.as_view(), name='new_shelter_review'),
    path('application/<int:application_id>/', ApplicationReviewListView.as_view(), name='application_reviews'),
    path('application/<int:application_id>/comment/', ApplicationReviewCreateView.as_view(), name='new_application_review'),
]
